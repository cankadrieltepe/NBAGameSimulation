...
public class PG extends player{
	...
	public PG(String Player_name, String position, double PTS, double TRB, double AST, double STL,double BLK,double score) {
		super(Player_name, position, PTS, TRB, AST,  STL, BLK,score);
		// TODO Auto-generated constructor stub
	}
	protected double PTS_weight=0.2;
	protected double TRB_weight=0.1;
